...
AppealsModel welcomeFromJson(String str) => AppealsModel.fromJson(json.decode(str));

String welcomeToJson(AppealsModel data) => json.encode(data.toJson());
...
class AppealsModel {
  ...
  factory AppealsModel.fromJson(Map<String, dynamic> json) => AppealsModel(
    status: WelcomeStatus.fromJson(json["status"]),
...
class WelcomeStatus {
  ...
  factory WelcomeStatus.fromJson(Map<String, dynamic> json) => WelcomeStatus(
    code: json["code"],
    description: json["description"],
    reqId: json["req_id"],
  );
